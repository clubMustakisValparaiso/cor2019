...
//------------------------------------------------Semi Intersecciones----------------------------------------------------------------------//
  //-----------------------------------------------------------------------------------------------------------------------------------------//
    ...
    else if (!digitalRead(12) && analogRead(0) > 300 && analogRead(1) > 300 && analogRead(7) < 300) {
 ...
 //------------------------------------------------------------------------------------------------------------------ 
  ...
  delay(500);
    ...
    delay(200);
      ...
      mover(200,200);
      delay(500);
      if(analogRead(0) < 500 ||analogRead(1) < 500 ||analogRead(2) < 500 ||analogRead(3) < 500 ||analogRead(6) < 500 ||analogRead(7) < 500  ){
        mover(200,200);
        delay(200);
      }
      else{
    ...
    else if (!digitalRead(13) && analogRead(7) > 500 && analogRead(6) > 500 && analogRead(0) < 500) {
